...
const Dashboard = () => {
  ...
  return !loading?(
    <>
            ...
            <p className='mt-20 text-lg font-medium'>Active Shows</p>
            <div className='relative flex flex-wrap gap-6 mt-4 max-w-5xl'>
                <BlurCircle top="100px" left="-10%"/>
                {dashboardData.activeShows?.map((show) => (  // Changed from dashboardCards.activeShows to dashboardData.activeShows
